...
import (
	...
	"github.com/a4anthony/go_bookings/internal/forms"
...
func (m *Repository) About(w http.ResponseWriter, r *http.Request) {
	...
	render.TemplateRender(w, r, "about.page.tmpl", &models.TemplateData{
		StringMap: stringMap,
	})
}
...
func (m *Repository) Generals(w http.ResponseWriter, r *http.Request) {
	render.TemplateRender(w, r, "generals.page.tmpl", &models.TemplateData{})
}

// Majors renders the room page
func (m *Repository) Majors(w http.ResponseWriter, r *http.Request) {
	render.TemplateRender(w, r, "majors.page.tmpl", &models.TemplateData{})
}

// Availability renders the search availability page
func (m *Repository) Availability(w http.ResponseWriter, r *http.Request) {
	render.TemplateRender(w, r, "search-availability.page.tmpl", &models.TemplateData{})
}
